...
from config import GenerateConfig, validate_config  # noqa: E402
from robocerebra_logging import (  # noqa: E402
    log_message,
    save_results_log,
    setup_logging,
)
...
from resume import create_step_based_resume_handler  # noqa: E402
...
def initialize_model(cfg: GenerateConfig):
    ...
    noisy_action_projector = (
        get_noisy_action_projector(cfg, model.llm_dim)
    ...
    assert unnorm_key in model.norm_stats, (
        f"Action un‑norm key {unnorm_key} not found!"
    )
...
def run_episode(
    ...
    while t < max_steps:
        ...
        obs, _, _, _ = env.step(
            process_action(raw_action, cfg.model_family).tolist()
        )
        t += 1
